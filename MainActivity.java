...
import static kevinhunte.speedometer.R.id.text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {//if the gps location changes
                speed =""+location.getSpeedAccuracyMetersPerSecond()+" m/s";//returns speed
                text.setText(speed);//sets this textView to now be the speed value
